...
<div class="wrapper">
    ...
    <aside class="main-sidebar" style="background: #a4093c ">
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Administración Optica Rojas</h3>
...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017-2020 <a href="www.incanatoit.com">Opticas</a>.</strong>Rojas.
</footer>
